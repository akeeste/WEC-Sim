...
classdef bodyClass<handle
    ...
    properties (SetAccess = 'public', GetAccess = 'public') %input file
        ...
        prodOfInertia     = [0 0 0]                          % (`3x1 float vector`) Rotational inertia or mass moment of inertia [kg*m^{2}]. Defined by the user in the following format [Ixx Iyy Izz]. Default = ``[]``.
