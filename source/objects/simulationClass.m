...
classdef simulationClass<handle
    ...
    properties (SetAccess = 'public', GetAccess = 'public')%input file
        ...
        solver              = 'ode4'                                       % (`string`) PDE solver used by the Simulink/SimMechanics simulation. Any Simulink solver can be used; 'ode4, 'ode45' are recommended for WEC-Sim. Default = ``'ode4'``
